...
.wm-world-frame-dock { display: flex; flex-direction: row; align-items: stretch; gap: 8px; padding: 0 10px; height: 34px; background: var(--nei-inset-bg); border: var(--nei-bevel-w) solid; border-color: var(--nei-shadow) var(--nei-highlight) var(--nei-highlight) var(--nei-shadow); border-left: none; border-right: none; border-top: none; border-bottom: none; flex-shrink: 0; }
