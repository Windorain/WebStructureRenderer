...
.wm-wfs__track { position: absolute; left: 0; right: 0; top: 50%; height: 8px; margin-top: -4px; background: var(--nei-inset-bg, #0f172a); border: var(--nei-bevel-w) solid; border-color: var(--nei-shadow) var(--nei-highlight) var(--nei-highlight) var(--nei-shadow); box-sizing: border-box; pointer-events: none; }
.wm-wfs__fill { position: absolute; left: 0; top: 50%; height: 6px; margin-top: -3px; margin-left: 2px; max-width: calc(100% - 4px); background: #2563eb; box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2); pointer-events: none; box-sizing: border-box; z-index: 1; }
...
.wm-wfs__label { flex-shrink: 0; font-size: 11px; font-family: ui-monospace, 'Cascadia Code', monospace; color: var(--nei-text-muted, #94a3b8); text-shadow: 0 1px 0 rgba(0, 0, 0, 0.4); min-width: 4.5em; text-align: right; }
</style>
