...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'downloadRaw': { zh: '下载 Raw', en: 'Download Raw' },
  'downloadCompact': { zh: '下载 Compact', en: 'Download Compact' },
  ...
  'rawDesc': { zh: 'Raw 为完整明文 JSON；Compact 为 gzip+Base64 信封。', en: 'Raw is full plain JSON; Compact is gzip+Base64 envelope.' },
